...
public class EntityBullet extends Entity
{
    ...
    public EntityBullet(World world, EntityLivingBase entityliving, double targetx, double targety, double targetz)
    {
        ...
        //double par9 = MathHelper.sin((float)(xdif * xdif + ydif * ydif + zdif * zdif));

        //accelerationX = xdif / par9 * 1.1d;

        //accelerationY = ydif / par9 * 1.1d;

        //accelerationZ = zdif / par9 * 1.1d;
    }
    ...
    private void onHit(RayTraceResult rtr)
    {
        ...
        if (entityHit != null && rtr.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, getShootingEntity()), damage))
        {
        	//Ok, this line looks out of left field, so, summary:
        	//if the entity hit is a creep and can't bleed, don't bleed.
