...
public class MoreCreepsAndWeirdos
{
    ...
    public static void registerEntities(RegistryEvent.Register<EntityEntry> event)
    {
        event.getRegistry().registerAll(
                ...
                createEntity(EntityEvilScientist.class, "evilscientist", MoreCreepsConfig.evilScientistSpawnAmt, 1, 1, EnumCreatureType.CREATURE, getBiomesNotType(Type.COLD, Type.SNOWY, Type.NETHER, Type.END))
        );
    }
